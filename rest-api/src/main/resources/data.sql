...
INSERT INTO Product (colorID, categoryID, name, price, description, sku) VALUES ('3', '3', 'Green Polo T-shirt', 34.99, 'Polo T-shirt in green color. An all time classeic items which has been loved by young and old alike.', 'GT234');
...
INSERT INTO Product (colorID, categoryID, name, price, description, sku) VALUES ('7', '6', 'Jacquemus Le Grand Chiquito leather top handle bag', 344.99, 'Pre-FW 2020 sees a return of the bag that upset the stereotype of soft, oversized women’s bags- the infamous Le Chiquito- in a brand new range of colorways. This season a record number of new bag silhouettes are also introduced, from surprisingly normal-sized tote bags to wicker versions of the Le Chiquito which replace the thin original leather shoulder strap with a large one made of fabric and with silver metal hooks.', 'WBAG234');
